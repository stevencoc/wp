		...
		<header id="site-header">
			...
			<div class="header-top section-inner">
				...
				if ( function_exists( 'the_custom_logo' ) && get_theme_mod( 'custom_logo' ) ) :
					...
					griddist_custom_logo();

				endif; ?>

				<button class="toggle nav-toggle" data-toggle-target=".mobile-menu-wrapper" data-toggle-scroll-lock="true">
					<label>
						<span class="show"><?php _e( 'Menu', 'griddist' ); ?></span>
						<span class="hide"><?php _e( 'Close', 'griddist' ); ?></span>
					</label>
					<div class="bars">
						<div class="bar"></div>
						<div class="bar"></div>
...
<div class="social-menu-wrapper">
	...
	$disable_search = get_theme_mod( 'griddist_disable_search' ) ? get_theme_mod( 'griddist_disable_search' ) : false;
