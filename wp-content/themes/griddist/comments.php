<?php if ( $comments ) : ?>
	...
	<div class="comments entry-content" id="comments">
		...
		$comments_title = sprintf( _nx( '%s Comment', '%s Comments', $comments_number, 'Translators: %s = the number of comments', 'griddist' ), $comments_number ); ?>
		...
		<div class="comments-header">
			...
			<?php if ( comments_open() ) : ?>
				...
				<a class="leave-comment-link" href="#respond"><?php _e( 'Add Yours &rarr;', 'griddist' ); ?></a>
...
elseif ( $comments ) : ?>
	...
	<div class="comment-respond" id="respond">
		...
		<p class="closed"><?php _e( 'Comments closed', 'griddist' ); ?></p>
